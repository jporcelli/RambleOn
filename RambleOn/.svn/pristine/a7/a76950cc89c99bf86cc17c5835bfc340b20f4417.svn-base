 ...
 */
public class AccountSelectionHandler implements ListSelectionListener, Serializable {
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        //RESET THE CELLS IN THE STATS TABLE OF THE CURRENT ACCOUNT PAGE TO THEIR INITIAL SATE
        screenManager.resetStatTableCells();
        //WE NEED TO CLEAR ALL THE REGIONS FROM THE REGIONS PLAYED TREE 
        //CURRENT ACCOUNT SCREEN
        screenManager.initRegionsPlayedTree();
        //RESET THE TABLE AND THE SELECTED CELLS
